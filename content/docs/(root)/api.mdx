...
| Prop     | Type                        | Description                                                                                                                       |
| -------- | --------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| ...props | `DrawOptions.MarkerOptions` | All props from [Leaflet Draw Marker options](https://leaflet.github.io/Leaflet.draw/docs/leaflet-draw-latest.html#markeroptions). |
...
When active, you can drag handles or markers to modify shapes, and an undo button appears to revert changes.
...
When active, clicking on a shape removes it. An undo button is available to revert deletions.
