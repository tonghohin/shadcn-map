...
The control is only visible if there are **multiple tile layers** or **layer groups** registered—if there’s only one tile layer and no layer group, it will not appear.
