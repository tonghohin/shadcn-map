...
| `position`         | `string`                         | Optional. Custom position for the control. Defaults to `top-1 right-1`.                          |
...
| Prop       | Type                          | Description                                                            |
| ---------- | ----------------------------- | ---------------------------------------------------------------------- |
| `position` | `string`                      | Optional. Custom position for the control. Defaults to `top-1 left-1`. |
| ...props   | `React.ComponentProps<"div">` | All props for the container `div`.                                     |

### MapFullscreenControl

The `MapFullscreenControl` component provides a button to toggle fullscreen mode for the map. It uses the `leaflet.fullscreen` library under the hood for robust cross-browser support.
...
| `position`        | `string`                            | Optional. Custom position for the control. Defaults to `right-1 bottom-1`.                                                                             |
| ...props          | `React.ComponentProps<"button">`    | All props for the `button` element.                                                                                                                    |
...
| `position`       | `string`                           | Optional. Custom position for the control. Defaults to `bottom-1 left-1`.                                                                                                 |
| ...props         | `React.ComponentProps<"div">`      | All props for the container `div`.                                                                                                                                        |
